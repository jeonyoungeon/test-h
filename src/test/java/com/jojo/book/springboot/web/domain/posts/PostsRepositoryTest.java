package com.jojo.book.springboot.web.domain.posts;
import com.jojo.book.springboot.domain.posts.Posts;
import com.jojo.book.springboot.domain.posts.PostsRepository;
...
// -> 여러 테스트가 동시에 수행되면 테스트용 데이터베이스인 H2에 데이터가 그대로 남아있어 다음 테스트 실행 시 테스트가 실패 할 수 있습니다.
    public void cleanup() {
